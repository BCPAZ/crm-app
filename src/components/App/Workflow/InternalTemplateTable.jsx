      ...
      <table className="w-full text-sm min-w-[1200px] border">
        ...
        <tbody className="w-full flex flex-col text-left">
          ...
          {templates.length > 0 ? (
              ...
              >
                <th className="text-sm font-medium text-gray-500 flex items-center gap-3 rounded-s-lg w-[50%]">
                  <div className="flex items-center gap-4">
                    <Link className="text-sm text-secondary hover:underline">
                      {template?.name}
                    </Link>
                  </div>
                </th>
            ...
            <div className="flex items-center justify-center h-full w-full p-10 font-semibold text-lg">
              Şablon mövcud deyil
            </div>
          )}
        </tbody>
...
export default InternalTemplateTable;
